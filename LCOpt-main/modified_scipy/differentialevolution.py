...
from scipy.optimize._differentialevolution import _FunctionWrapper
try:
    from scipy.optimize._optimize import _status_message
except:
    from scipy.optimize.optimize import _status_message
from scipy._lib._util import check_random_state, MapWrapper#, FunctionWrapper
...
class DifferentialEvolutionSolver:
    ...
    def _accept_trial(self, energy_trial, feasible_trial, cv_trial,
        ...
        * it is infeasible, but provides a lower or equal constraint violation
        ...
        This testing_brute.py corresponds to section III of Lampinen [1]_.
