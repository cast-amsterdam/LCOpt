...
def plot_result(result_list, sample_name):
    ...
    fig, ax, ax2 = plot_chromatogram.plot_chromatogram(tR_list, W_list, phi_list, t_list, t_0, t_D, t_init, result_list[2], return_fig=True)
    return fig, ax, ax2