...
def plot_chromatogram(t_R_list, pw_list, phi_list, t_list, t_D, t_0, t_init, score, plot_individual_peaks=False, return_fig=True):
    """
    ...
    :plot_individual_peaks: Whether to plot the individual peaks or not.
    :return_fig: Whether to return the figure or not. Shows the figure if False.
    """
    #print(t_R_list)
    ...
    if(case == 1):
        ...
        ax2.set_xlim(xmin=-0.1, xmax=end_time_chromatogram)
    else:
        ax2.set_xlim(xmin=-0.1, xmax=end_time_profile)
